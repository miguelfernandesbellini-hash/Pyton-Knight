...
window.AssetCatalog.v6_coin={...window.AssetCatalog.coin_pile,derived:true,description:'Pilha original com piso neutro removido em SpriteAtlasSystem; cores do ouro preservadas'};
for(const role of ['wall_face_main','wall_face_alt','wall_top_main'])window.AssetCatalog[`v6_${role}`]={...window.AssetCatalog[role],derived:true,description:'Alvenaria original na paleta violeta do piso, derivada em SpriteAtlasSystem'};
